...
export async function load({ locals }) {
    ...
    console.log("Start fetching carousel movies for", locals.participant.sessionId, new Date().toISOString());
    ...
    try {
        ...
        console.log('Done fetching carousel movies for', locals.participant.sessionId, new Date().toISOString());
